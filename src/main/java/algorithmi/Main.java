...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        get("/api/quiz/:id", (request, response) -> {
            return "Hello World";
        });

        post("/api/quiz", (request, response) -> {
            return "Hello World";
        });

        put("/api/quiz/:id", (request, response) -> {
            return "Hello World";
        });

        delete("/api/quiz/:id", (request, response) -> {
            return "Hello World";
        });
        ...
        post("/api/course", (request, response) -> {
            return "Hello World";
        });

        put("/api/course/:id", (request, response) -> {
            int status = 400;
            String data = null;
        ...
        post("/api/school", (request, response) -> {
            return "Hello World";
        });
        ...
        get("/api/students", (request, response) -> {
            ...
            try {
                return User.listStudents().toString();
            } catch (Exception ex) {
                Logger.getLogger(Main.class.getName()).log(Level.SEVERE, null, ex);
